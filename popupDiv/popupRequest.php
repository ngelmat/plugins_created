<?php
global $pathPopupDiv;
$pathPopupDiv = "http://consumerlifestyledigest.com//wp-content/plugins/popupDiv";
...
function dr_hugo_testimonial() {
    ...
    <img alt=""  src="<?php echo $pathPopupDiv; ?>/images/img-hugo.png" />
</div>
<div class="testimonial_content">
    <img alt=""  src="<?php echo $pathPopupDiv; ?>/images/M.gif" style="float: left; margin: 0px; width: 45px;"/>
    ...
    <p>
        ...
        LifeCell has my undiluted highest recommendation.
            ...
            <img alt="signature" src="<?php echo $pathPopupDiv; ?>/images/hugos_sign.png" style="width:150px"/>
                <br>
...
<div class="content_part2">
            <div class="article_2">
                ...
                <div class="article_content">
                    ...
                    <p align="center"><img width="136" height="141" alt="wrikles" src="<?php echo $pathPopupDiv; ?>/images/image_girl.jpg"></p>
                    <p>
				...
				<div class="article_content">
					...
					<p align="center">
						 <img alt=""  src="<?php echo $pathPopupDiv; ?>/images/logo_life_cell_bkg_white.jpg" />
					 </p>
			   </div>
            </div>
                    ...
                    <div class="article_3">
                        <div class="article_content">
                            ...
                            <p>
                             ...
                             <p align="center">
                                 <img alt=""  src="<?php echo $pathPopupDiv; ?>/images/lifecell_product.png" />
                             </p>
                        </div>
                </div>
         </div>
...
?>
	<div class="testimonial_content">
		...
		<p>
			<img src="<?php echo $pathPopupDiv; ?>/images/nbc_Logo.gif"
			style="float: left;
			padding: 5px;"/>
				<div
		...
		<p style="border-bottom: 1px solid #D9D9D9;">
			<img src="<?php echo $pathPopupDiv; ?>/images/fitness_magazine_Logo.gif"
			style="float: left;
			padding: 5px;"/>
				<div
				style="text-align: left;
		...
		<div class="clr"></div>
		<p style="border-bottom: 1px solid #D9D9D9;">
			<img src="<?php echo $pathPopupDiv; ?>/images/time_Logo.gif"
			style="float: left;
			padding: 5px;"/>
				<div
				style="text-align: left;
		...
		<div class="clr"></div>
		<p style="border-bottom: 1px solid #D9D9D9;">
			<img src="<?php echo $pathPopupDiv; ?>/images/the_times_Logo.gif"
			style="float: left;
			padding: 5px;"/>
				<div
				style="text-align: left;
		...
		<div class="clr"></div>
		<p style="border-bottom: 1px solid #D9D9D9;">
			<img src="<?php echo $pathPopupDiv; ?>/images/7_news_boston_Logo.gif"
			style="float: left;
			padding: 5px;"/>
				<div
				style="text-align: left;
			...
			<p style="center">
				<div style="border: 5px outset gray; width:70%; margin: 10px 100px 10px 100px; ">
					<div style="height:70px;">
						<img width="68" height="68" border="0" align="left" src="<?php echo $pathPopupDiv; ?>/images/medal_t.jpg" style="margin:10px 0px 0px 10px;">
					...
					<div style="text-align:center;">
						<img width="400" height="190" border="0" alt="" src="<?php echo $pathPopupDiv; ?>/images/nobel_t.jpg">
					</div>
